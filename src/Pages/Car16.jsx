  ...
  return (
    ...
    <div className='flex flex-col md:flex-row items-center justify-center'>
      <div id="box-image" className='flex flex-col items-center gap-4'>
        <img className='mt-10' src={GraySportsCar }  width={500}/>
        <span className='text-black dark:text-white font-extrabold text-4xl'>Gray Sports Car </span>
        <p className="text-black dark:text-white font-bold text-2xl text-center">11 500$</p>
