  ...
  return (
    ...
    <div className='flex flex-col md:flex-row items-center justify-around'>
      <div id="box-image" className='flex flex-col items-center gap-4'>
        <img className='mt-10' src={lamborghini}  width={500}/>
        <span className='text-black dark:text-white font-extrabold text-4xl'>Lamborghini</span>
      ...
      <div id="box-input" className='flex flex-col items-center gap-7'>
        <p className='text-black dark:text-white text-2xl font-bold mt-11'>70$ لليوم الواحد</p>
